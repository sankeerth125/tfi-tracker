      ...
      <main className="container mx-auto px-4 py-8 max-w-5xl space-y-8">
        <div className="text-center space-y-2">
          ...
          <p className="text-muted-foreground">
            Compare collections, budgets, and verdicts side-by-side.
          </p>
        </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
              <div className="w-full md:w-64">
                <MovieSelector
                  movies={movies || []}
                  value={movie1Id}
                  onValueChange={setMovie1Id}
                  placeholder="Select Movie A"
                />
              </div>
              ...
              <div className="w-full md:w-64">
                <MovieSelector
                  movies={movies || []}
                  value={movie2Id}
                  onValueChange={setMovie2Id}
                  placeholder="Select Movie B"
                />
              </div>
            </div>
          </CardContent>
          ...
          <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Estimated comparisons based on reported data
                </CardDescription>
              </CardHeader>
              <CardContent className="h-[400px]">
                <ResponsiveContainer width="100%" height="100%">
                  ...
                  >
                    ...
                    <Legend />
                    <Bar
                      dataKey={movie1.title}
                      fill="#111827"
                      radius={[4, 4, 0, 0]}
                    />
                    <Bar
                      dataKey={movie2.title}
                      fill="#16a34a"
                      radius={[4, 4, 0, 0]}
                    />
                  </BarChart>
              ...
              <div className="relative overflow-hidden rounded-xl border bg-gradient-to-r from-gray-900 to-gray-800 p-8 text-center text-white">
                <div className="relative z-10 flex flex-col items-center gap-4">
                  ...
                  <p className="text-gray-300 max-w-md">
                    See precise distributor shares, territory-wise breakdowns,
                    and ROI percentages with a Pro account.
                  </p>
                  <Link href="/pro">
